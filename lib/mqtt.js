...
exports.create = ({ config, cecApi }) => {
  ...
  service.start = () => {
    ...
    mqttClient.on('connect', () => {
      ...
      mqttClient.subscribe(`${topicPrefix}/device/audio/input/on`, turnAudioOn.bind(null));
      mqttClient.subscribe(`${topicPrefix}/device/audio/input/off`, turnAudioOff.bind(null));
    });
