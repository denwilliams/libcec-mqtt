...
exports.create = () => {
  ...
  cec.once( 'ready', function(client) {
    ...
    client.sendCommand( 0xf1, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf2, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf3, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf4, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf5, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf6, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf7, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf8, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xf9, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xfa, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xfb, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xfc, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xfd, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
    client.sendCommand( 0xfe, CEC.Opcode.GIVE_DEVICE_POWER_STATUS );
  });
